...
| Fase 4 | Os modelos lógico, de implementação e de dados representam o mesmo recorte funcional e oferecem uma estrutura documentada para o sistema. | Não apresentar os diagramas como prova de uso real nem antecipar estruturas de funcionalidades futuras. |
...
- recompensas e notificações serão relacionadas à participação e ao engajamento, mantendo a viabilidade técnica das notificações como questão ainda em avaliação;
