...
| Referências bibliográficas — `referencias`    | Codex       | Em planejamento | `artifacts/planejamento-referencias.md`; `artifacts/auxiliares/referencias-utilizadas.md` | Planejamento e mapa central criados em 2026-09-07 conforme D-015 e atualizados em 2026-09-08 para incluir as considerações finais. O inventário relaciona as fontes externas usadas no RESUMO, no ABSTRACT, nas Fases 1, 2, 4, 6, 7 e 8 e na síntese final, incluindo ISO/IEC/IEEE 14764:2022 e SWEBOK Guide V4.0a na Fase 8. Permanecem a conferência dos metadados e a produção de `artifacts/referencias.md` na integração. |
