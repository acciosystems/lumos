...
| Fase 4 — `fase-04`                            | Codex       | Concluído | `artifacts/planejamento-fase-04.md`; `artifacts/texto-fase-04.md`; fontes Mermaid em `artifacts/diagramas/` | Correções de coerência concluídas em 2026-09-05: casos de uso detalhados, relações entre atores e atributos das modalidades no DER. Em 2026-09-07, os fundamentos conceituais receberam referências da OMG (2017), de Chen (1976), da documentação de DER do Mermaid e da OWASP, registradas no mapa central. D-024 foi incorporada em uma discussão própria sobre evolução e D-025 orientou a apresentação positiva do recorte funcional, sem alterar os diagramas do MVP. A exportação dos diagramas foi adiada para a etapa condicional de diagramação final e não impede a conclusão da fase. |
