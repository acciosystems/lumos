...
| D-012 | Na Fase 4, substituir a pesquisa bibliográfica ou on-line solicitada por explicações autorais e sem referência para os tópicos 4.1 a 4.4. Produzir os diagramas em Mermaid e não citar diretamente arquivos do repositório no texto destinado ao TCC. | Esclarecimento explícito do usuário nesta tarefa. | Fase 4 e integração | Codex / 2026-09-05 |
...
| Fase 2 — `fase-02`                            | Codex       | Concluído       | `artifacts/planejamento-fase-02.md`; `artifacts/texto-fase-02.md`    | Redação, conferência das fontes locais e revisão acadêmica concluídas em 2026-09-05. D-010 distingue dados publicados, documentos de projeto e inferências.                                                                                                                                                 |
...
| Fase 6 — `fase-06`                            | Codex       | Em redação | `artifacts/planejamento-fase-06.md`; `artifacts/texto-fase-06.md`; `artifacts/imagens/fase-06/formularios/`; `artifacts/diagramas/fase-06-classes.mmd` | Partes 0 (congelamento), 1 (padrão do sistema), 2 (inventário textual de telas), 3 (capturas de formulários) e 4 (diagrama de classe) concluídas. A Parte 5 foi redigida sob a premissa, fornecida pelo usuário em 2026-09-07, de que TSDoc foi adotado como alternativa a JAVADOC/SUMMARY e já cobre APIs e módulos relevantes, sem incluir componentes React. As 19 imagens F01–F19 foram obtidas pelo Chrome DevTools MCP em ambiente local, com dados fictícios e revisão de legibilidade. Permanecem a única imagem do tópico TSDoc e a Parte 6, de consolidação e revisão final. |
...
| Referências bibliográficas — `referencias`    | Codex       | Em planejamento | `artifacts/planejamento-referencias.md`; `artifacts/auxiliares/referencias-utilizadas.md` | Planejamento e mapa central inicial criados em 2026-09-07 conforme D-015. O inventário relaciona as fontes externas já usadas no RESUMO, no ABSTRACT e nas Fases 1, 2 e 6. Permanecem a atualização pelas partes futuras, a conferência dos metadados e a produção de `artifacts/referencias.md` na integração. |
